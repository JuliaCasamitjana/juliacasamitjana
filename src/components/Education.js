            ...
            <div className="education__main">
                ...
                <div className="education__timeline">
                    <div className="education__item">
                        <p className="education__item__small">Sept. 2008 - June 2013</p>
                    ...
                    <div className="education__item">
                        <p className="education__item__small">Sept. 2013 - Sept. 2014</p>
                    ...
                    <div className="education__item">
                        <p className="education__item__small"> Aug. 2016</p>
                    ...
                    <div className="education__item">
                        <p className="education__item__small">Jan. 2017</p>
                    ...
                    <div className="education__item">
                        <p className="education__item__small"> Mar. 2020</p>
                    ...
                    <div className="education__item">
                        <p className="education__item__small">Mai 2020</p>
                    ...
                    <div className="education__item">
                        <p className="education__item__small">June 2020</p>
