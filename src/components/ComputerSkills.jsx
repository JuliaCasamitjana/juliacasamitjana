      ...
      <div className="computer__main">
        ...
        <div className="computer__content">
          <div className="computer__skill">
            <FontAwesomeIcon size="2xl" icon={faHtml5} className="home__card" />
          ...
          <div className="computer__skill">
            <FontAwesomeIcon size="2xl" icon={faJsSquare} className="home__card" />
          ...
          <div className="computer__skill">
            <FontAwesomeIcon size="2xl" icon={faReact} className="home__card" />
          ...
          <div className="computer__skill">
            <FontAwesomeIcon size="2xl" icon={faNodeJs} className="home__card" />
            <p className="computer__skill__info">
          ...
          <div className="computer__skill">
            <FontAwesomeIcon size="2xl" icon={faDatabase} className="home__card" />
            <p className="computer__skill__info">
          ...
          <div className="computer__skill">
            <FontAwesomeIcon size="2xl" icon={faFileCode} className="home__card" />
            <p className="computer__skill__info">
          ...
          <div className="computer__skill">
            <FontAwesomeIcon size="2xl" icon={faCogs} className="home__card" />
          ...
          <div className="computer__skill">
            <FontAwesomeIcon size="2xl" icon={faWordpress} className="home__card" />
          ...
          <div className="computer__skill" id="test">
            <FontAwesomeIcon size="2xl" icon={faVideo} className="home__card" />

            <p className="computer__skill__info">I have worked with video editors such as Camtasia and Final Cut Pro.</p>
          </div>
          <div className="computer__skill">
            <FontAwesomeIcon size="2xl" icon={faWindows} className="home__card" />
